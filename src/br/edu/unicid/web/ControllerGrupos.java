...
public class ControllerGrupos {
	...
	public String login() {
		...
		// NOME DO GRUPO ERRADO
				...
				FacesContext ctx = FacesContext.getCurrentInstance();
				ctx.addMessage("messages", new FacesMessage("NOME DA EQUIPE incorreto (mai�sculas e minusculas n�o fazem diferen�a tanto faz ex: Equipe como EQUIPE), tente novamente. Caso n�o consiga se lembrar entre em contato conosco: jadircmj@hotmail.com"));
