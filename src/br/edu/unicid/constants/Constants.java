...
public class Constants {
	...
	public static final String TOAST_SAVED_WITH_SUCCESS      = URL_PARAMETER.concat("Salvo com sucesso");
	public static final String TOAST_CHANGES_HAVE_BEEN_SAVED = URL_PARAMETER.concat("Suas alterações foram salvas");
	public static final String TOAST_DELETED_WITH_SUCCESS    = URL_PARAMETER.concat("Excluído com sucesso!");
	public static final String TOAST_DELETED                 = URL_PARAMETER.concat("Excluído!");
	public static final String TOAST_SOMETHING_WENT_WRONG    = URL_PARAMETER.concat("Algo não aconteceu como o esperado!");
	public static final String TOAST_GENERIC_ERROR           = URL_PARAMETER.concat("Erro! Tente novamente mais tarde.");
	
	
	public static final String PAGE_NEW_INTERVIEW           = "/create/novaEntrevista";
	public static final String PAGE_NEW_PROFSSOR            = "/create/novoProfessor(TEMPORARIAMENTE REMOVIDO)";
