	...
	<div class="container">
		<div class="row">
			<div class="col-sm-2 col-sm-offset-1">			
				<img src="images/valores.jpg" width="150px" class="img-circle pull-left">
			</div>
			<div class="col-sm-8">
				<div class="block-sobre">
					<h3><font color="black">Participe de nossos Treinamentos</font></h3>
					<p align="justify">
					Você está convidado a participar de um dos nossos cursos de extensão.
					Nossa meta é contribuir com o desenvolvimento de profissionais de TI e estudantes 
					que buscam crescimento profissional.
					</p>
					<p align="justify">
					Confira nossa agenda de cursos e planeje a sua certificação, realize a prova na própria Universidade.
					Tire sua certificação ainda este semestre e conquiste o emprego do seu sonho.
					</p>
				...
				<div class="block-sobre">
					...
					<p align="justify">
					Reúna seus amigos e confira as vantagens em fazer nosso treinamento.<br />

					Material Didático e Coffee Break incluso.<br />
					Parcele seu curso em até 10 vezes sem juros no cartão de crédito<br />
					</p>					
