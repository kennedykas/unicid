                        ...
                        <div class="input-group">
                            ...
                            <div>
                                <div class="radio">
                                    ...
                                    <label class="radio"><input ${mapTemVaga.get("5") ? '' : 'disabled'} type="radio" name="palestraN" value="5"><strong>(CANCELADA)</strong>Machine Learning e Microsoft Azure  - 19:30 às 22:30 ${mapTemVaga.get("5")?'':'Sem Vagas'} </label>
                    ...
                    <div style="padding-top:5px" class="panel-body" > <div class="input-group">
                            ...
                            <div class="radio">
                                <div>
                                    ...
                                    <label class="radio"><input ${mapTemVaga.get("24") ? '' : 'disabled'} type="radio" name="oficinaN"value="24">Desenvolvendo Jogos com Construction 2 - 19:30 às 22:30 ${mapTemVaga.get("24")?'':'Sem Vagas'} </label>   
                                </div>
                            </div>
                        </div>  
                    </div> 
