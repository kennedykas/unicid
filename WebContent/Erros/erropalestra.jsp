...
<html>
    <head>
        ...
        <title>Erro de Cadastro para Palestra e Oficina</title>
                    ...
                    <div class="content-wrap">
                        ...
                        <div class="main-title">
                            ...
                            <ul class="grid effect-8">
                                ...
                                <h1>As Palestras ou Oficinas não estão mais disponivéis!</h1>
                                <h1>Tente novamente com outras palestras ou oficinas.</h1>
                            ...
                            <div class= "lines">
                                ...
                                <div class="more-btn">
                                    <a href="/wecti/menu.jsp" class="btn btn-danger">Tentar Novamente.</a>
                                </div>
...
<!--    
<center>
    <img src="<%//=request.getContextPath()%>/images/internet.jpg" alt=""/>
